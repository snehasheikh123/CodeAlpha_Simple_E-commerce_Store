<?php
session_start();
require 'db_connect.php'; // Set up connection
...
<html lang="en">
<head>
    <title><?php echo htmlspecialchars($product['product_name']); ?> — Minishop</title>
    <meta charset="utf-8">
  ...
  <div class="py-1 bg-black">
    ...
    <div class="hero-wrap hero-bread" style="background-image:url('images/bg_6.jpg');">
      <div class="container text-center">
        ...
        <h1 class="mb-0 bread"><?php echo htmlspecialchars($product['product_name']); ?></h1>
      </div>
    </div>
    ...
    <section class="ftco-section">
          ...
          <div class="col-lg-6 product-details pl-md-5 ftco-animate">
            ...
            <div class="rating d-flex">
              <p class="text-left mr-4">
                <a href="#" class="mr-2"><?php echo number_format($product['rating'], 1); ?></a>
                <?php for($i=0; $i<5; $i++): ?>
              ...
              <p class="text-left mr-4">
                <a href="#" class="mr-2" style="color: #000;"><?php echo $product['sold']; ?> <span style="color: #bbb;">Sold</span></a>
              </p>
              <p class="text-left">
                <a href="#" class="mr-2" style="color: #000;"><?php echo $product['sold']; ?> <span style="color: #bbb;">Rating</span></a>
              </p>
            </div>
      ...
      <?php endif; ?>
                ...
                <div class="form-group d-flex">
                  <div class="select-wrap">
                    ...
                    <select name="size" class="form-control">
                      <option value=""><?php echo htmlspecialchars($product['size']); ?></option>
              ...
              <div class="w-100"></div>
              <div class="col-md-12">
                <p style="color: #000;"><?php echo $product['availability']; ?> piece available</p>
              </div>
            </div>
